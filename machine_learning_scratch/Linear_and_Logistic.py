...
if __name__ == "__main__":
    ...
    regressor = LinearRegression(learning_rate=0.01, n_iters=1010)
    regressor.fit(X_train, y_train)
    predictions = regressor.predict(X_test)

    acc = r2_score(y_test, predictions)
    print("Linear ACC :", acc)
    ...
    regressor = LogisticRegression(learning_rate=0.0001, n_iters=1010)
    regressor.fit(X_train, y_train)
    predictions = regressor.predict(X_test)

    print("Logistic accuracy:", accuracy(y_test, predictions))